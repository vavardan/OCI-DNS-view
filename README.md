...
- VM (**web01-p.ssnpweb.vcnprod.oraclevcn.com**) in prod Spoke VCN performs nslookup to get IP address of VM (**web02-pp.ssnppweb.vcnpreprod.oraclevcn.com**) located in the preprod Spoke VCN.
